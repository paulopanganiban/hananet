                ...
                <ul class="topbar-items fadeInDown" [ngClass]="{'topbar-items-visible': appMain.topbarMenuActive}">
                    <li #profile class="profile-item" *ngIf="app.profileMode==='top'|| appMain.isHorizontal()"
                        ...
                        <a href="#" (click)="appMain.onTopbarItemClick($event,profile)">
                                  <ng-container *ngIf="this.userService.pictureUrl$ | async as pictureUrl">
                            <img class="profile-image" [src]="pictureUrl || 'assets/layout/images/avatar.png'" />
                            </ng-container>
                            <div>
                            <ng-container *ngIf="this.userService.userCredentials$ | async as userCredentials">
